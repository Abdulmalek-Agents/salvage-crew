...
| 3 | **Quaternius Industrial Sci-Fi Kit** (free) | Free | Crates, valves, props | ✅ |
...
| 5 | **Mixamo Animations** | Free | Walk/run/idle/carry/interact |
| 6 | **Sci-Fi Creatures / Drones pack (Quaternius)** | Free | Mission 4 drones |
...
| 9 | **Steam Lobby Sample for Mirror** (community, free) | Free | Lobby template |

## D. Audio

| # | Asset | $ | Use |
|---|---|---|---|
| 10 | **Sci-Fi Industrial SFX Pack** (Cafofo / Hzandbits) | $25 | Hull, doors, alarms, breach |
...
| # | Asset | $ | Use |
|---|---|---|---|
| 13 | URP Volumetric Fog (Beautify 3 or free Atmospheric Height Fog) | Free–$40 | Wreck atmosphere |
| 14 | **VFX Graph samples** (Unity, free) | Free | Breach particles, sparks |
...
| Tier | Cost |
|---|---|
| Must-have | **~$185** (2× Synty + SFX + VO) |
| Nice-to-have | +$95 (Beautify + Odin + helmet SFX) |
| **Ceiling** | **~$280** if you take everything |
| **Recommended cap** | **~$220** |
...
└── Mirror/            ← Imported, NOT committed (it's third-party)
